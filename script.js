...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hour >= 19 || hour <= 7) {
        // Night Time
        navbar.style.backgroundImage = "url(images/snow2.gif)"; // Replace with your night image path
        // Add snowflakes effect
    } else {
        // Day Time
        navbar.style.backgroundImage = "url(images/snow2.gif)"; // Replace with your day image path
        // Add sun effect
    }
});
